...
namespace OpenGL__Tutorial
{
    public class Game : GameWindow
    {
        ...
        protected override void OnLoad()
        {
            ...
            camera = new Camera(new Vector3(3.0f, 3.0f, 3.0f), Size.X / (float)Size.Y);
;
            CursorState = CursorState.Grabbed;
        }
        ...
        protected override void OnRenderFrame(FrameEventArgs e)
        {
            ...
            Matrix4 model = Matrix4.CreateTranslation(new Vector3(-20.0f, 0.0f, 0.0f)) * Matrix4.CreateRotationY((float)MathHelper.DegreesToRadians(90)) * Matrix4.CreateScale(0.2f);
            ...
            #region Queen piece
            Matrix4 queenModel = Matrix4.CreateTranslation(2.0f, 10.0f, 0.0f) * Matrix4.CreateRotationY((float)MathHelper.DegreesToRadians(90)) * Matrix4.CreateScale(0.1f);
